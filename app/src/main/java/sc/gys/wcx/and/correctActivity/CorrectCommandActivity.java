package sc.gys.wcx.and.correctActivity;
...
import sc.gys.wcx.and.startActivity.WebPostRemarkActivity;
import sc.gys.wcx.and.R;
import sc.gys.wcx.and.help.CacheUtils;
import sc.gys.wcx.and.help.PermissionsUtils;
import sc.gys.wcx.and.sanEntery.CorrecTmsgWithBLOBs;
import sc.gys.wcx.and.sanEntery.JwNowchufamsg;
import sc.gys.wcx.and.sanEntery.JwYinhuanMsg;
...
/*    @ViewInject(R.id.toolbar_bank)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* 赋值标题 */
        if(mTitleParment.length() > 15){
            mTextView.setPadding(10,0,0,0);
            String substring = mTitleParment.substring(0, 15);
            mTextView.setText(substring+"...");
        }else {
            mTextView.setPadding(10,0,0,0);
            mTextView.setText(mTitleParment);
        }
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mTitleParment.equals("旺苍县公安局责令改正通知书")){
                    ...
                    e.setBianhao2(Integer.valueOf(0));                          //责通字

...
public class CompanyGouseAdapter extends RecyclerView.Adapter<CompanyGouseAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(sc.gys.wcx.and.R.layout.public_company_iten_image, parent, false);
    ...
    public void getGesture(final ImageView imageView,final String fileName) {
        ...
        View myView = LayoutInflater.from(mContext).inflate(sc.gys.wcx.and.R.layout.my_gesure_xml, null, false);
        GestureOverlayView gesure = (GestureOverlayView) myView.findViewById(sc.gys.wcx.and.R.id.dialog_gesture);
        ...
        // 设置参数
        builder.setTitle("提示").setIcon(sc.gys.wcx.and.R.mipmap.icon_app)
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        @ViewInject(sc.gys.wcx.and.R.id.mCompany_SetMing)
        ImageView mCompany_SetMing;
        @ViewInject(sc.gys.wcx.and.R.id.mCompany_QianMing)
        ImageView mCompany_QianMing;
        @ViewInject(sc.gys.wcx.and.R.id.mCompany_Nmae)

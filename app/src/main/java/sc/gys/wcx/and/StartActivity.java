...
import sc.gys.wcx.and.startActivity.AdvertisingActivity;
 ...
 *
 */
@ContentView(sc.gys.wcx.and.R.layout.activity_start)
public class StartActivity extends AppCompatActivity {
    ...
    //首页图片
    @ViewInject(sc.gys.wcx.and.R.id.start_activity_img)
    ...
    private void CreatAnimacationAll() {
        ...
        Animation scaleAnimation= AnimationUtils.loadAnimation(this, sc.gys.wcx.and.R.anim.login_scale_img);

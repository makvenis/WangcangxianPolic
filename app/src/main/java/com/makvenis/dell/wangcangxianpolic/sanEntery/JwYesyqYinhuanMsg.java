...
public class JwYesyqYinhuanMsg {
    ...
    private Date yqStarttime;

    private Date yqEndtime;
    ...
    public Date getYqStarttime() {
        return yqStarttime;
    }

    public void setYqStarttime(Date yqStarttime) {
        this.yqStarttime = yqStarttime;
    }

    public Date getYqEndtime() {
        return yqEndtime;
    }

    public void setYqEndtime(Date yqEndtime) {
